    ...
    <>
          <Layout/>
            ...
            <div className="page-header">
                <h1 className="page-title my-auto">Transport</h1>
                    ...
                    <div className="row">
                            <div className="col-xl-12">
                                        ...
                                        <div className="prism-toggle">
                                            ...
                                            <div className="modal-dialog modal-dialog-centered">
                                                ...
                                                <div className="modal-header">
                                                    <h4 className="modal-title" id="exampleModalLabel">Add Transport</h4>
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-lg-6 col-md-6 col-sm-6">
                                                    <div className="mb-3">
                                                        <label htmlFor="exampleInputEmail1" className="form-label">Transport Licence</label>
                                                        <input type="email" className="form-control" id="exampleInputEmail1" placeholder='Last name' aria-describedby="emailHelp"/>
                                                    </div>
                                                    </div>
                                                    <div className="col-lg-6 col-md-6 col-sm-6">
                                                    <div className="mb-3">
                                                        <label htmlFor="exampleInputEmail1" className="form-label">Number Vehicel</label>
                                    ...
                                    <div className="card-body p-0">
                                         ...
                                         <div className="col-lg-2">
                                            <div className="mb-3">
                                            <label htmlFor="exampleFormControlInput1" className="form-label">Number Vehicel</label>
                                            <select className="form-select "  aria-label="Default select example">
                                                <option selected>Select Number Vehicel</option>
                                                <option value="1">12366</option>
                                                <option value="2">25396</option>
                                                <option value="3">25369</option>
                                            </select>
                                            </div>
                                         </div>
                                         <div className="col-lg-2">
                                            ...
                                            <table className="table text-nowrap border table-striped table-hover rounded">
                                                <thead className=''>
                                                    <tr>
                                                        ...
                                                        <th scope="col">Transport Licence</th>
                                                        <th scope="col">Number Vehicel</th>
                                                        <th scope="col">Area </th>
                                                        <th scope="col">Owner Name</th>
                                                        <th scope="col">Office Address</th>
                                                        <th scope="col">Transport Location</th>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>789456123123</td>
                                                        <td>
                                                        <Link to="" className="text-info fs-14 lh-1" data-bs-toggle="modal" data-bs-target="#exampleModald"><i className="ri-edit-line me-2"></i></Link>
                                                        <div className="modal fade modal-lg " id="exampleModald" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div className="modal-dialog modal-dialog-centered">
                                                            <div className="modal-content p-3">
                                                            <div className="modal-header">
                                                                <h4 className="modal-title" id="exampleModalLabel">Edite Transport</h4>
                                                                <button type="button" className="btn-close text-primary" data-bs-dismiss="modal" aria-label="Close"></button>
                                                            </div>
                                                            <div className="modal-body">
                                                                <form>
